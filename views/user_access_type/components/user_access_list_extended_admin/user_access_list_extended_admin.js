...
export default {
    name: "ExtendedAdminUserAccessList",
    components: {
    ...
    methods: {
        ...
        getUserAccessList: function () {
            if (this.$userRoleAccess(this.applianceId, 'permitApprovedExtendedAdminList')) {
        ...
        renderUserAccessList: function () {
            ...
            let userList = this.$store.state.userAccessList.userAccessListExtendedAdmin.userInformation;
            let userPermissionInfo = this.$store.state.userAccessList.userAccessListExtendedAdmin.userPermissionInfo;
            ...
            this.$root.$emit("extended_admin_list_length", this.listLength);
        },
        //-------------------------------------
        //-------------------------------------
