...
export default {
    ...
    methods: {
        ...
        inviteSuccess: function () {
            console.log(this.$store.state.userAccessList.addOwnerResponse);
            if (this.$store.state.userAccessList.addOwnerResponse.promptInvite) {
        ...
        inviteError: function () {
            this.ApiError = true;
            this.errorMsg = this.$store.state.userAccessList.addOwnerResponse.message;
            this.updateView();
        },
        //-------------------------------------
        ...
        closeTimeRestDialog: function () {
            console.log("closeTimeRestDialog");
            this.fullScreenDialog = false;
        },
        //----------------------------------
        saveTimeScheduler: function () {
            console.log("saveTimeScheduler");
            this.defaultTimeRestriction = this.$store.state.timeRestrictionStore.savedTimeRestrictionOwner;
            this.fullScreenDialog = false;
        }
    }
};